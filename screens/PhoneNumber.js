  ...
  return (
    ...
    <View style = {{flexDirection: 'row', marginTop: 15}}>
      <TouchableOpacity onPress={handleCall}  style = {style.BTIn1}>
        <Image source = {require('../img/ตำรวจ.png')} style ={style.Img1} />
      ...
      <TouchableOpacity onPress={handleCall2} style = {style.BTIn1}>
        <Image source = {require('../img/กองปราบปราม.png')} style ={style.Img2} />
        <View>
    ...
    <View style = {{flexDirection: 'row', marginTop: 20}}>
      <TouchableOpacity onPress={handleCall3} style = {style.BTIn2}>
        <Image source = {require('../img/ตำรวจทางหลวง.png')} style ={style.Img3} />
        <View style = {{marginLeft: 5}}>
      ...
      <TouchableOpacity onPress={handleCall4} style = {style.BTIn2}>
        <Image source = {require('../img/วชิรพยาบาล.png')} style ={style.Img4} />
        <View>
    ...
    <View style = {{flexDirection: 'row', marginTop: 20}}>
      <TouchableOpacity onPress={handleCall5} style = {style.BTIn1}>
        <Image source = {require('../img/สถาบันการแพทย์.png')} style ={style.Img1} />
        <View style = {{marginLeft: 5}}>
      ...
      <TouchableOpacity onPress={handleCall6} style = {style.BTIn1}>
        <Image source = {require('../img/หน่วยแพทย์ฉุกเฉิน.png')} style ={style.Img1} />
        <View>
    ...
    <View style = {{flexDirection: 'row', marginTop: 20}}>
      <TouchableOpacity onPress={handleCall7} style = {style.BTIn2}>
        <Image source = {require('../img/การทางพิเศษแห่งประเทศไทย.png')} style ={style.Img3} />
        <View style = {{marginLeft: 5}}>
      ...
      <TouchableOpacity onPress={handleCall8} style = {style.BTIn2}>
        <Image source = {require('../img/พบเจออุบัติเหตุทางน้ำ.png')} style ={style.Img5} />
        <View>
          <Text style = {style.NumMar5}>1154</Text>
    ...
    <View style = {{flexDirection: 'row', marginTop: 20}}>
      <TouchableOpacity onPress={handleCall9} style = {style.BTIn1}>
        <Image source = {require('../img/แจ้งเหตุไฟไหม้ดับเพลิง.png')} style ={style.Img6} />
        <View style = {{marginLeft: 5}}>
      ...
      <TouchableOpacity onPress={handleCall10} style = {style.BTIn1}>
        <Image source = {require('../img/จส.100.png')} style ={style.Img7} />
        <View>
    ...
    <View style = {{flexDirection: 'row', marginTop: 20, marginBottom: 30}}>
      <TouchableOpacity onPress={handleCall11} style = {style.BTIn2}>
        <Image source = {require('../img/กรมทางหลวงชนบท.png')} style ={style.Img3} />
        <View style = {{marginLeft: 5}}>
      ...
      <TouchableOpacity onPress={handleCall12} style = {style.BTIn2}>
        <Image source = {require('../img/สถานีวิทยุร่วมด้วยช่วยกัน.png')} style ={style.Img8} />
        <View>
